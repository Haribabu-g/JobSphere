    ...
    <div className='container 2xl:px-20 mx-auto flex flex-col lg:flex-row max-lg:space-y-8 py-8'>
        ...
        <div className='w-full lg:w-1/4 bg-white px-4'>
            {/* search filter from hero component*/}
            {
                ...
                <>
                    <h3 className='font-bold text-lg mg-4'>Current Search</h3>
                    <div className='mb-4 text-gray-600'>
                        {
                            searchFilter.title && (
                                <span className='inline-flex items-center gap-2.5 bg-blue border border-blue-200 px-4 py-1.5 rounded'>
                                     {searchFilter.title}   
                                      <img 
                        ...
                        }
                        {
                            searchFilter.location && (
                                <span className=' ml-2 inline-flex items-center gap-2.5 bg-red border border-red-200 px-4 py-1.5 rounded'>
                                    {searchFilter.location}
                                    <img 
        ...
        <section className='w-full lg:w-3/4 text-gray-800 max-lg:px-4'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4'>
                 ...
                 {filteredJobs.length > 0 && (
                    ...
                    {Array.from({length:Math.ceil(filteredJobs.length/6)}).map((_,index)=>(<a key={index}href="#job-list">
