    ...
    <form onSubmit={onSubmitHandler} className='container p-4 flex flex-col w-full items-start gap-3'>
        ...
        <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
            <div>
                <p className='mb-2'>
                    Job Category  </p>
                    <select className='w-ful px-3 py-2 border-2 border-gray-300 rounded cursor-pointer' onChange={e => setCategory(e.target.value)}>
            ...
            <div>
                <p className='mb-2'>
                    Job Location  </p>
                    <select className='w-ful px-3 py-2 border-2 border-gray-300 rounded cursor-pointer' onChange={e => setLocation(e.target.value)}>
            ...
            <div>
                <p className='mb-2'>
                    Job Level  </p>
                    <select className='w-ful px-3 py-2 border-2 border-gray-300 rounded cursor-pointer' onChange={e => setLevel(e.target.value)}>
        ...
        <button className='w-28 py-2 mt-4 bg-black text-white rounded cursor-pointer'>
            ADD
        </button>
